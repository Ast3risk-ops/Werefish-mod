...
package net.mcreator.werefish.block;
...
public class ApertureBlock extends WerefishModElements.ModElement {
	@ObjectHolder("werefish:aperture")
	public static final Block block = null;
	public ApertureBlock(WerefishModElements instance) {
		super(instance, 3);
	}
