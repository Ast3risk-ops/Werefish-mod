...
package net.mcreator.werefish.world.dimension;
...
public class TNTDimensionDimension extends WerefishModElements.ModElement {
	@ObjectHolder("werefish:tnt_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public TNTDimensionDimension(WerefishModElements instance) {
		super(instance, 1);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("werefish:tnt_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("tnt_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("tnt_dimension_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("tnt_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new TNTDimensionItem().setRegistryName("tnt_dimension"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("tnt_dimension_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("werefish:tnt_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("werefish:tnt_dimension")));
				} else {
					entity.func_242279_ag();
