...
package net.mcreator.werefish.entity;
...
import net.mcreator.werefish.entity.renderer.WerewolfRenderer;
import net.mcreator.werefish.WerefishModElements;

@WerefishModElements.ModElement.Tag
public class WerewolfEntity extends WerefishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(79).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("werewolf").setRegistryName("werewolf");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletwerewolf").setRegistryName("entitybulletwerewolf");
	public WerewolfEntity(WerefishModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WerewolfRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -10066330, new Item.Properties().group(ItemGroup.COMBAT))
